...
\subsection{Obtención e instalación}
    ...
    \begin{itemize}
        ...
        \item Node.js y npm (o yarn) para el frontend Angular
        \item Git para clonar el repositorio
        \item MySQL 5.7 instalado y configurado
    \end{itemize}
    
    \subsubsection{Backend}
    \begin{enumerate}
        \item \textbf{Obtención del código fuente}\\\\
        Clonar el repositorio desde GitHub: git clone https://github.com/SrNe0/HorarioUIS.git
    \end{enumerate}
